...
net1 = models.__dict__['resnet32_quan1'](200)
net = models.__dict__['resnet32_quan'](200)
...
I_t=np.array(I_t)
np.save('./save/resnet32_tiny/sdn_adaptive/SNI.npy',I_t)

#I_t = np.load('./save/resnet32_tiny/sdn_adaptive/SNI.npy',allow_pickle=True)
for i in range(len(I_t)):
...
#perturbed = torch.load('./save/resnet32_tiny/sdn_adaptive/perturbed.pth')
