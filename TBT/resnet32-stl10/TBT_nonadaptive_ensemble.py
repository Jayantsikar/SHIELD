...
class Attack(object):
    ...
    # [CHANGED] Fixed CUDA index-out-of-bounds crash.
    # tar contains column indices (0-63) of the quan_Linear(64->10) weight matrix.
    # The loss must be computed in the 64-dim penultimate avgpool feature space,
    # not the 10-class output — attach a forward hook on the avgpool layer.
...
import numpy as np
# [CHANGED] Ensure result dir exists before writing
os.makedirs('./result', exist_ok=True)
...
# Original: y=net2(x_var)[15] -> shape [1,10] -> CRASH on tar values > 9.
# Fix: hook avgpool to get [1,64] feature and set target in that space.
_feat_init = []
...
## testing before trojan insertion
validate(loader_test, net, criterion, 16)
...
for epoch in range(200):
    ...
    if (epoch+1)%50==0:
        ...
        torch.save(net.state_dict(), './result/final_trojan_nonadaptive_ensemble.pkl')
...
print('\n============================================================')
print('  SUMMARY — Non-Adaptive Ensemble (STL-10)')
print('============================================================')
...
with open('./result/final_results_nonadaptive_ensemble.txt', 'w') as f:
    f.write(f'TBT Non-Adaptive Ensemble Attack Results (STL-10)\n')
    f.write(f'========================================\n')
