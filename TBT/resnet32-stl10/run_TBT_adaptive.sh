#!/bin/bash
#SBATCH --job-name=tbt_stl10_adap
#SBATCH --partition=gpu-P100
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=4
#SBATCH --mem=32G
#SBATCH --time=04:00:00
#SBATCH --output=%j_tbt_stl10_adaptive.out
...
mkdir -p "$SLURM_SUBMIT_DIR/result_stl10_adaptive"
cp -r result/* "$SLURM_SUBMIT_DIR/result_stl10_adaptive/" 2>/dev/null || true
echo "=== DONE: Adaptive Baseline TBT (STL-10) results saved to $SLURM_SUBMIT_DIR/result_stl10_adaptive/ ==="
