...
np.savetxt('./result/TBTresnet_trojan_img1.txt', x_tri[0,0,:,:].cpu().numpy(), fmt='%f')
np.savetxt('./result/TBTresnet_trojan_img2.txt', x_tri[0,1,:,:].cpu().numpy(), fmt='%f')
np.savetxt('./result/TBTresnet_trojan_img3.txt', x_tri[0,2,:,:].cpu().numpy(), fmt='%f')
