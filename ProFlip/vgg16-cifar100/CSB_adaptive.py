...
net = models.__dict__['vgg16_quan1'](100)
net1 = models.__dict__['vgg16_quan'](100)
...
loader_train = torch.utils.data.DataLoader(trainset, batch_size=256, shuffle=True, num_workers=2) 
...
def find_psens(model, data_loader, perturbed):
    ...
    for batch_idx, (data, target) in enumerate(data_loader):
        ...
        for i in range(len(y)):
            #if i==7 or i==13 or i==14:
            #if i==6 or i==7 or i==12 or i==13 or i==14:
            #if i==6 or i==7 or i==8 or i==11 or i==12 or i==13 or i==14:
            #if i==5 or i==6 or i==7 or i==8 or i==9 or i==11 or i==12 or i==13 or i==14:
            #if i==4 or i==5 or i==6 or i==7 or i==8 or i==9 or i==10 or i==11 or i==12 or i==13 or i==14:
            #if i==2 or i==3 or i==4 or i==5 or i==6 or i==7 or i==8 or i==9 or i==10 or i==11 or i==12 or i==13 or i==14:
            # if i>3:
                y[i][:,I_t[i]] = 10
        break
