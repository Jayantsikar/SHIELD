...
trainset = torchvision.datasets.STL10('../../stl10/vgg16/data',
                                split='train',
                                transform=train_transform,
                                download=True)
testset = torchvision.datasets.STL10('../../stl10/vgg16/data',
                               split='test',
...
#Loading the weights
pretrain_dict = torch.load('../../stl10/vgg16/save_finetune/model_best.pth.tar')
...
for param in net.parameters(): 
    ...
    #if n==22 or n==46 or n==70 or n==94 or n==118 or n==142 or n==166 or n==214 or n==262 or n==286 or n==310 or n==334 or n==358 or n==368:
