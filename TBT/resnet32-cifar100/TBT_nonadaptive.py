...
testset = torchvision.datasets.CIFAR100(root='../../cifar10/resnet32/data', train=False, download=True, transform=transform_test) 
...
net_d = models.__dict__['resnet32_quan1'](100)
