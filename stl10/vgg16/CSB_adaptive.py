...
net = models.__dict__['vgg16_quan1'](10)
net1 = models.__dict__['vgg16_quan'](10)
pretrain_dict = torch.load('./save_finetune/model_best.pth.tar',map_location='cpu')
...
trainset = torchvision.datasets.STL10('/data2/workplace/ziyuan/datasets/stl10',
                                split='train',
                                transform=train_transform,
                                download=True)
testset = torchvision.datasets.STL10('/data2/workplace/ziyuan/datasets/stl10',
                               split='test',
                               transform=test_transform,
                               download=True)
loader_train = torch.utils.data.DataLoader(trainset, batch_size=2, shuffle=True, num_workers=2) 
loader_test = torch.utils.data.DataLoader(testset, batch_size=6, shuffle=False, num_workers=2)
